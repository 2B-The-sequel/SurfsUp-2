...
namespace SurfsUp.Data.Migrations
{
    ...
    [Migration("20220911125505_Rental")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurfsUp.Models.Users", b =>
                {
                    b.Property<int>("UsersId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SurfsUp.Models.Rental", b =>
                {
                    b.HasOne("SurfsUp.Models.Board", "Board")
                        .WithOne("Rental")
                        .HasForeignKey("SurfsUp.Models.Rental", "BoardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SurfsUp.Models.Users", "User")
                        .WithMany("Rentals")
